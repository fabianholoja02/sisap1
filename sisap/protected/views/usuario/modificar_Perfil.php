...
$this->menu=array(
	...
	array('label' => Yii::t('AweCrud.app', 'View').' Perfil', 'icon' => 'eye-open', 'url'=>array('ver_Perfil', 'id' => $model->id)),
...
<fieldset>
    <legend><?php echo ' ' . Usuario::label().': '; ?> <?php echo CHtml::encode($model) ?></legend>
    <?php echo $this->renderPartial('_form_Perfil',array('model' => $model)); ?>  
</fieldset>