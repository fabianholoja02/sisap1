...
class MovimientoCajaController extends AweController
{
	/**
...
public function accessRules() {
	...
	public function actionCreate()
	{
        ...
        $this->performAjaxValidation($model, 'movimiento-caja-form');
	...
	{
		$dataProvider=new CActiveDataProvider('MovimientoCaja');
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax'] === 'movimiento-caja-form')
		{
