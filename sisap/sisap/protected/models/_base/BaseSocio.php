...
abstract class BaseSocio extends AweActiveRecord {
    ...
    public function relations() {
        return array(
            'socioMedidors' => array(self::HAS_MANY, 'SocioMedidor', 'CODIGO_SOCIO'),
            'usuario' => array(self::BELONGS_TO, 'Usuario', 'COD_USUARIO'),
            //'medidor'=>array(self::MANY_MANY, 'Medidor', 'socioMedidors(CODIGO_SOCIO, ID_MEDIDOR)'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
                ...
                'CI' => Yii::t('app', 'CI/RUC'),
                'APELLIDO' => Yii::t('app', 'Nombre Completo'),
